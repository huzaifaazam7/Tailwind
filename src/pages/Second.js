...
const Second = () => {
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          ...
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">Social media marketing offers a unique opportunity for businesses to build a strong online presence and cultivate brand loyalty. Unlike traditional advertising, social media enables direct interaction with consumers, allowing brands to respond to inquiries, address concerns, and engage in conversations. This two-way communication fosters a sense of trust and connection between the brand and its audience, which is essential for long-term success. By consistently providing value through engaging content, businesses can nurture relationships that lead to customer retention and advocacy.</p>
      </div>
...
<button type="button" class="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Click Here To Go Next Page!</button>
</div>
</Link>
      </div>
    )
